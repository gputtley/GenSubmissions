...
# with command line options: --python_filename miniaod_2017.py --eventcontent MINIAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier MINIAODSIM --fileout file:MINIAOD.root --conditions 94X_mc2017_realistic_v14 --step PAT --scenario pp --filein file:AOD.root --era Run2_2017,run2_miniAOD_94XFall17 --runUnscheduled --no_exec --mc -n 200 --nThread 4
