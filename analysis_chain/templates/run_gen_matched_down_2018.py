...
# with command line options: Configuration/GenProduction/python/MUO-RunIISummer18wmLHEGS-00003-fragment.py --python_filename run_gen_matched_2018.py --eventcontent RAWSIM,LHE --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM,LHE --fileout file:output.root --conditions 101X_upgrade2018_realistic_v7 --beamspot Realistic25ns13TeVEarly2017Collision --customise_commands process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=int(1) --step LHE,GEN,SIM --geometry DB:Extended --era Run2_2018 --no_exec --mc -n 100
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/MUO-RunIISummer18wmLHEGS-00003-fragment.py nevts:100'),
