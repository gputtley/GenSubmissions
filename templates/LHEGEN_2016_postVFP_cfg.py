...
# with command line options: Configuration/GenProduction/python/HIG-RunIISummer20UL16wmLHEGEN-01536-fragment.py --python_filename HIG-RunIISummer20UL16wmLHEGEN-01536_1_cfg.py --eventcontent RAWSIM,LHE --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN,LHE --fileout file:HIG-RunIISummer20UL16wmLHEGEN-01536.root --conditions 106X_mcRun2_asymptotic_v13 --beamspot Realistic25ns13TeV2016Collision --customise_commands process.source.numberEventsInLuminosityBlock=cms.untracked.uint32(348) --step LHE,GEN --geometry DB:Extended --era Run2_2016 --no_exec --mc -n 4962
...
process.maxEvents = cms.untracked.PSet(
    input = cms.untracked.int32(4962)
)
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/HIG-RunIISummer20UL16wmLHEGEN-01536-fragment.py nevts:4962'),
...
#        filterName = cms.untracked.string('')
#    ),
#    fileName = cms.untracked.string('file:HIG-RunIISummer20UL16wmLHEGEN-01536_inLHE.root'),
...
process.source.numberEventsInLuminosityBlock=cms.untracked.uint32(348)
