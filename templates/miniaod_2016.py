...
# with command line options: --python_filename miniaod_2016.py --eventcontent MINIAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier MINIAODSIM --fileout file:MINIAOD.root --conditions 94X_mcRun2_asymptotic_v3 --step PAT --filein file:AOD.root --era Run2_2016,run2_miniAOD_80XLegacy --runUnscheduled --no_exec --mc -n 200 --nThread 4
