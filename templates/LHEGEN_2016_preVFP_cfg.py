...
# with command line options: Configuration/GenProduction/python/HIG-RunIISummer20UL16wmLHEGENAPV-00757-fragment.py --python_filename HIG-RunIISummer20UL16wmLHEGENAPV-00757_1_cfg.py --eventcontent RAWSIM,LHE --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN,LHE --fileout file:HIG-RunIISummer20UL16wmLHEGENAPV-00757.root --conditions 106X_mcRun2_asymptotic_preVFP_v8 --beamspot Realistic25ns13TeV2016Collision --customise_commands process.source.numberEventsInLuminosityBlock=cms.untracked.uint32(344) --step LHE,GEN --geometry DB:Extended --era Run2_2016_HIPM --no_exec --mc -n 4684
...
process.maxEvents = cms.untracked.PSet(
    input = cms.untracked.int32(4684)
)
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/HIG-RunIISummer20UL16wmLHEGENAPV-00757-fragment.py nevts:4684'),
...
#        filterName = cms.untracked.string('')
#    ),
#    fileName = cms.untracked.string('file:HIG-RunIISummer20UL16wmLHEGENAPV-00757_inLHE.root'),
...
process.source.numberEventsInLuminosityBlock=cms.untracked.uint32(344)
